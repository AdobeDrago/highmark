...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-sidebar-article.js
  var import_sidebar_article_exports = {};
  __export(import_sidebar_article_exports, {
    default: () => import_sidebar_article_default
  });
  ...
  // tools/importer/transformers/highmark-listing-sections.js
  var SECTIONS = [
  ...
  var PAGE_TEMPLATE = {
    ...
    description: "Two-column layout with a left-hand section navigation sidebar and a long-form article body of headings, paragraphs, and bulleted lists",
    urls: [
      "https://www.highmark.com/resources/answers/articles/spending-accounts",
      "https://www.highmark.com/resources/mental-health-services/eating-disorders/eating-disorder-types"
    ],
    blocks: [
  ...
  var import_sidebar_article_default = {
    transform: (payload) => {
      const {
        document: document2,
        url,
  ...
  return __toCommonJS(import_sidebar_article_exports);
})();
