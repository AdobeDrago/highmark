...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-sidebar-listing.js
  var import_sidebar_listing_exports = {};
  __export(import_sidebar_listing_exports, {
    default: () => import_sidebar_listing_default
  });
  ...
  var import_sidebar_listing_default = {
    transform: (payload) => {
      const {
        document: document2,
        url,
  ...
  return __toCommonJS(import_sidebar_listing_exports);
})();
