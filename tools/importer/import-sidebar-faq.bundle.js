...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-sidebar-faq.js
  var import_sidebar_faq_exports = {};
  __export(import_sidebar_faq_exports, {
    default: () => import_sidebar_faq_default
  });
  ...
  var import_sidebar_faq_default = {
    transform: (payload) => {
      const {
        document: document2,
        url,
  ...
  return __toCommonJS(import_sidebar_faq_exports);
})();
