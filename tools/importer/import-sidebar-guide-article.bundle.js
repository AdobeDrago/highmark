...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-sidebar-guide-article.js
  var import_sidebar_guide_article_exports = {};
  __export(import_sidebar_guide_article_exports, {
    default: () => import_sidebar_guide_article_default
  });
  ...
  // tools/importer/transformers/highmark-guide-article-sections.js
  ...
  var import_sidebar_guide_article_default = {
    transform: (payload) => {
      const {
        document: document2,
        url,
  ...
  return __toCommonJS(import_sidebar_guide_article_exports);
})();
